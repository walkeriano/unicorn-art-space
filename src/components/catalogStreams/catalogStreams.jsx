...
import styles from "./catalogStreams.module.css";
import Image from "next/image";

export default function CatalogStreams() {
  // Lista de cursos
  const courses = [
    {
      id: 1,
  ...
  return (
    <section className={styles.containerWorkshops}>
      ...
      <section className={styles.boxOverflow}>
        {courses.map((course) => (
          <section key={course.id}   className={`${styles.itemCard} ${
