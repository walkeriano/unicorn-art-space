import styles from "./heroWorkshops.module.css";
import Image from "next/image";
import Menu from "@/components/menu/menu";
import Link from "next/link";

export default function HeroWorkshops({ id }) {
  return (
    <section className={styles.heroContainer}>
      <section id={id} className={styles.titleBox}>
        <h1>workshops profesionales</h1>
        <h2>Capacitaciones interactivas y personalizadas</h2>
      ...
      <section className={styles.contextService}>
        ...
        <div className={styles.contImg}>
          <Image
            src="/art-workshops.png"
            className={styles.bgOficial}
            fill={true}
            alt="bg-personaje-service"
          />
          <Image
            src="/art-workshops-2.png"
            className={styles.bgResponsive}
            fill={true}
            alt="bg-personaje-service"
          />
        </div>
